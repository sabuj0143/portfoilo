    ...
    return (
        <div className="my-14">
            <div className="title text-center mx-auto">
                <h3 className="w-[20%] mx-auto cursive text-4xl border-0 border-b-2 border-primary">About Me</h3>
            </div>
            <div>
                <div className="hero mt-5">
                    <div className="hero-content flex-col lg:flex-row">
                        ...
                        <div className='pl-8'>
                            <p className="py-6">Hi, I'm Sabuj Howlader, a full stack web developer. Web design & development is my passion. I love to explore new tech things.
